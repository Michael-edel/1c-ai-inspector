...
def test_agent_execution_persists_model_usage() -> None:
    ...
    with Session(engine) as session:
        ...
        assert report.model_usage.model == get_settings().model_name
        assert report.model_usage.duration_ms >= 0
        ...
        assert usage.pricing_source == "openai-public:gpt-5.5:2026-07-14"

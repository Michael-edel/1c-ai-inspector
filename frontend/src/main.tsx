...
type Report = { status: string; summary: string; sourceCoverage?: "full" | "partial" | "none" | "unknown"; findings: ReportFinding[]; persistedFindings: PersistedFinding[]; limitations?: string[]; nextActions?: string[]; objectsReviewed?: string[]; validation?: { readOnly?: boolean; sourceComplete?: boolean; sourceEvidence?: { status?: string; invalidCount?: number; excerptCount?: number; droppedFindings?: number }; retrievalTools?: string[] }; toolUsage?: { calls: number; durationMs: number }; modelUsage?: { inputTokens: number; outputTokens: number; estimatedCost: number }; execution?: { promptVersion: string; modelProvider: string; modelName: string; policyVersion: string; policyChecksum: string; toolsetChecksum: string } };

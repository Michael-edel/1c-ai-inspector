...
type PatchProposal = { id: string; status: string; title: string; summary: string; sourceRevision: string | null; diff: string; impact: PatchImpact[]; checkpointRef: string | null; approvedBy: string | null; approvalNote: string | null; sourceValidationStatus: string };
...
function App() {
  ...
  const runPatchAction = async (action: "impact" | "revalidate" | "checkpoint" | "approve" | "reject") => {

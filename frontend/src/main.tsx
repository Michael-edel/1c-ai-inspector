...
function App() {
  ...
  const cancelTask = async () => {
    if (!taskId || !["queued", "running"].includes(taskStatus) || cancelBusy) return;
    setCancelBusy(true);
    setError("");
    try {

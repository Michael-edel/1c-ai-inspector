...
type Audit = { task_id: string; status: string; events: { type: string }[]; tool_calls: { toolName: string; mode: string; status: string; durationMs: number | null; errorCode: string | null }[]; model_usage: { model: string; estimatedCost: number; durationMs: number; cachedInputTokens: number }[] };
